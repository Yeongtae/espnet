...
#utils/validate_data_dir_myown.sh --no-text --no-feats ${data} || exit 1;
echo 'done validate_data_dir'
...
echo 'done script_scps'

utils/split_scp.pl ${scp} ${split_scps} || exit 1;

echo 'done utils/split_scp.pl'
...
echo 'done write_num_frames_opt'
